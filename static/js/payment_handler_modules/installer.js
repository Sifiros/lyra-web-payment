function showMessage(message) {
  ...
  function check() {
    ...
    console.log("navigator handle service worker !");
    ...
    navigator.serviceWorker
      ...
      .then(registration => {
        ...
        console.log("app.js registered for service worker, running in parallel thread");
        ...
        console.log("Browser handle payment handler !");
        ...
        registration.paymentManager.instruments
          .has('instrument-key')
          .then(result => {
            console.log("Result of registration payment manager instrument coming:");
            console.log(result);
